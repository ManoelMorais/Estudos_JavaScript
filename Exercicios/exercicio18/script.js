...
let teste = new Date()
    ...
    console.log(teste.toLocaleString('pt-BR', option))
...
function getUserPosition(){
    ...
    navigator.geolocation.getCurrentPosition((pos) => {
        ...
        url = `https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${log}&units=imperial&APPID=288e077f4ef940c7467b2a1d30d02473`
        fetchApi(url)
        console.log(url)
    })
}
